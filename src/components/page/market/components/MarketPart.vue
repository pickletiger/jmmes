<template>
  <div>
    <el-container class="project-main">
      <el-header class="header">部件信息</el-header>
      <el-main>
        <div class="main">
              ...
              <el-collapse accordion>
                <el-collapse-item title="子部件1">
                 <el-form>
                  ...
                  <el-form-item label="工艺路线2"></el-form-item>
